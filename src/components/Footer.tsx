        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[var(--gray-400)] text-sm leading-relaxed mb-6">
              ...
              soluciones integrales en contabilidad, asesoria legal, marketing y
              talento humano.
            </p>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service.name}>
                  <Link
                    href={service.href}
                    className="text-[var(--gray-400)] hover:text-[var(--gold)] transition-colors text-sm"
                  >
                    {service.name}
                  </Link>
                </li>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-lg mb-6">Enlaces Rapidos</h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-[var(--gray-400)] text-sm hover:text-[var(--gold)] transition-colors"
                >
                  marketingpotenciav2@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[var(--gray-400)] text-sm">
              &copy; {new Date().getFullYear()} Potencia V2. Todos los derechos
              reservados.
            </p>
